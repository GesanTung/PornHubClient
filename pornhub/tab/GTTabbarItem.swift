...
extension TabControllerType {
    var data: CMTabBarItemData {
        switch self {
        case .home:
            return .init(title:"首页", dayImage: #imageLiteral(resourceName: "tab_home_s_icon"), nightImage: #imageLiteral(resourceName: "tab_home_s_icon"), seletedImage: #imageLiteral(resourceName: "tab_home_n_icon"))
        case .found:
            return .init(title:"发现", dayImage: #imageLiteral(resourceName: "tab_found_s_icon"), nightImage: #imageLiteral(resourceName: "tab_found_s_icon"), seletedImage: #imageLiteral(resourceName: "tab_found_n_icon"))
        case .mine:
            return .init(title:"我的", dayImage: #imageLiteral(resourceName: "tab_mine_s_icon"), nightImage: #imageLiteral(resourceName: "tab_mine_s_icon"), seletedImage: #imageLiteral(resourceName: "tab_mine_n_icon"))
        }
    }
